                ...
                <div style={{
                    ...
                    <div style={{ position: 'relative', zIndex: 2 }}>
                        <h2 style={{ fontSize: '2.5rem', fontWeight: 900, color: 'white', marginBottom: '1rem', lineHeight: 1.1 }}>
                            JOIN AS <span style={{ color: 'var(--primary)' }}>{String(role).toUpperCase()}</span>
                        </h2>
                        <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '1.1rem', maxWidth: '350px' }}>
                            Become part of our premium network and access elite remote work opportunities.
                        </p>
                ...
                <div style={{
                    ...
                    <div style={{ marginTop: 'auto' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', margin: '0.5rem 0 1rem' }}>
                            ...
                            <span style={{ fontSize: '0.75rem', color: 'rgba(255,255,255,0.3)' }}>Or register with:</span>
                            <div style={{ flex: 1, height: '1px', background: 'rgba(255,255,255,0.1)' }} />
                        </div>
                        ...
                        <p style={{ marginTop: '1.5rem', textAlign: 'center', fontSize: '0.9rem', color: 'rgba(255,255,255,0.4)' }}>
                            Already have an account? <Link href={`/login/${role}`} style={{ color: 'rgba(255,255,255,0.7)', fontWeight: 600 }}>Login here</Link>
                        </p>
                    </div>
                </div>
            </div>
