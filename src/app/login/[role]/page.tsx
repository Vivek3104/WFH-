        ...
        <div
            ...
            <div className="premium-glass" style={{
                ...
                <div style={{
                    ...
                    <div>
                        <h1 style={{ fontSize: '2rem', fontWeight: 600, marginBottom: '0.25rem' }}>Login</h1>
                        <p style={{ fontSize: '0.9rem', color: 'rgba(255,255,255,0.5)' }}>Enter your {role} credentials</p>
                    </div>
                    ...
                    <div style={{ marginTop: 'auto' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', margin: '0.5rem 0 1rem' }}>
                            ...
                            <span style={{ fontSize: '0.75rem', color: 'rgba(255,255,255,0.3)' }}>Or login with:</span>
                            <div style={{ flex: 1, height: '1px', background: 'rgba(255,255,255,0.1)' }} />
                        </div>
                        ...
                        <p style={{ marginTop: '1.5rem', textAlign: 'center', fontSize: '0.9rem', color: 'rgba(255,255,255,0.4)' }}>
                            New here? <Link href={`/register/${role}`} style={{ color: 'rgba(255,255,255,0.7)', fontWeight: 600 }}>Create {role} account</Link>
                        </p>
                    </div>
                </div>
            </div>
